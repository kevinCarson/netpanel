...
inv_omega <- function(theta, n, t) {
    .Call(`_netpanel_inv_omega`, theta, n, t)
}

det_omega <- function(theta, n, t) {
    .Call(`_netpanel_det_omega`, theta, n, t)
}
...
pnam_ll_random <- function(netA, sigma2, v, n, t, theta) {
    .Call(`_netpanel_pnam_ll_random`, netA, sigma2, v, n, t, theta)
}
